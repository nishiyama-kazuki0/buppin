...
/// 解凍受渡位置到着情報内容VIEWモデル
/// </summary>
public class VW_ARRIVALTHAWPOS_INFO_Model : AbstractViewModelBaseExtension
{
    /// <summary>
    /// VIEW名
    /// </summary>
    public const string VIEW_NAME = "VW_ARRIVALTHAWPOS_INFO";
    ...
    /// </summary>
    [Column("位置1デパレカウントNO")]
    public short DepalletizeCountNO1 { get; set; } = 0;
    /// <summary>
    /// 位置2デパレカウントNO
    /// </summary>
    [Column("位置2デパレカウントNO")]
    public short DepalletizeCountNO2 { get; set; } = 0;
