...
/// 在庫受払照会画面
/// </summary>
public partial class InventoryReceiptAndPayment : ChildPageBasePC
{
    /// <summary>
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        [
            new TabItemInfo() { Title = "正袋受払", TabItem = new TabItemInventoryStock() },
            new TabItemInfo() { Title = "端数受払", TabItem = new TabItemInventoryStockPart() },
            new TabItemInfo() { Title = "パレット受払", TabItem = new TabItemInventoryPallet() },
        ];
