...
namespace ExpressionDBBlazorShared.Pages
{
    ...
    /// パレット移動
    /// </summary>
    public partial class MobileInventoryWork : ChildPageBaseMobile
    {
        /// <summary>
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            {
                new StepItemInfo() { Title = "移動先入力", StepItem = new StepShelfSelection() },
                new StepItemInfo() { Title = "棚一覧", StepItem = new StepInventoryWork() },
