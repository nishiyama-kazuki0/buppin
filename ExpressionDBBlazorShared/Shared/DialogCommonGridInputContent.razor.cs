...
/// <summary>
/// グリッド付きのダイアログベースを宣言
/// グリッドベースはChildPageBaseを継承することにより対応しているため、
/// グリッド動作のカスタマイズはChildPageBaseを編集すること
/// </summary>
public partial class DialogCommonGridInputContent : ChildPageBase
{
