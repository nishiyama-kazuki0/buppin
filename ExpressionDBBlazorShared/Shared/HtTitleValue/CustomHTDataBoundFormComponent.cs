...
/// Implements the <see cref="RadzenComponent" />
/// Implements the <see cref="IRadzenFormComponent" />
/// </summary>
/// <typeparam name="T"></typeparam>
/// <seealso cref="RadzenComponent" />
/// <seealso cref="IRadzenFormComponent" />
public class CustomHTDataBoundFormComponent<T> : RadzenComponent, IRadzenFormComponent
{
    ...
    /// The form
    /// </summary>
    private IRadzenForm _form = null!;
    ...
    public object Value
    {
        ...
        set
        {
            if (_value != value)
            {
                _value = Equals(value, "null") ? null : value;
            }
        }
    }
    ...
    public virtual bool HasValue => typeof(T) == typeof(string) ? !string.IsNullOrEmpty($"{Value}") : Value != null;
    ...
    protected virtual IQueryable Query => Data?.AsQueryable();
    ...
    /// The search text
    /// </summary>
    internal string searchText = null!;
    ...
    [Parameter]
    public required Expression<Func<T>> ValueExpression { get; set; }
    /// <summary>
    ...
    {
        bool searchTextChanged = parameters.DidParameterChange(nameof(SearchText), SearchText);
        if (searchTextChanged)
        {
            searchText = parameters.GetValueOrDefault<string>(SearchText);
        }

        bool dataChanged = parameters.DidParameterChange(nameof(Data), Data);
        ...
        bool disabledChanged = parameters.DidParameterChange(nameof(Disabled), Disabled);
    ...
    {
        return ClassList.Create(className)
    ...
    [CascadingParameter]
    public required IFormFieldContext FormFieldContext { get; set; }
